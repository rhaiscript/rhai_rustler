...
pub fn to_error(env: Env, err: EvalAltResult) -> Term {
    let error_atom = match err {
        ...
        EvalAltResult::ErrorMismatchOutputType(_, _, _) => atoms::mismatch_output_type(),
        ...
        EvalAltResult::ErrorAssignmentToConstant(_, _) => atoms::assignment_to_constant(),
    ...
    make_reason_tuple(env, error_atom, err)
}

fn make_reason_tuple(env: Env, atom: rustler::types::atom::Atom, err: EvalAltResult) -> Term {
